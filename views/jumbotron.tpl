<div class="bckgnrd-color jumbotron">
    <h1>Upload your images !</h1>
    <p>Browse your files locally, upload your images and enjoy them in a gallery. Clic on an image to see it in a carousel !</p>
    <br/>
